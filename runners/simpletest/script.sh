...
phpcov execute $DRUPAL_TI_SCRIPT_DIR/utility/launch-simpletest.sh bash --configuration $DRUPAL_TI_DRUPAL_DIR/$DRUPAL_TI_MODULES_PATH/$DRUPAL_TI_PHPCOV_XML --html $DRUPAL_TI_DRUPAL_DIR/coverage-report
