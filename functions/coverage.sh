...
function drupal_ti_ensure_simpletest_coverage_tools() {
  ...
  cp -R $TRAVIS_BUILD_DIR/$TRAVIS_REPO_SLUG DRUPAL_TI_TMP_MODULE_PATH
...
function drupal_ti_simpletest_coverage_install_module() {
  ...
  echo "CPing $DRUPAL_TI_SIMPLETEST_PATH to $DRUPAL_TI_DRUPAL_DIR/$DRUPAL_TI_MODULES_PATH/$DRUPAL_TI_MODULE_NAME"
  cp -R "$DRUPAL_TI_SIMPLETEST_PATH" "$DRUPAL_TI_DRUPAL_DIR/$DRUPAL_TI_MODULES_PATH/$DRUPAL_TI_MODULE_NAME"
